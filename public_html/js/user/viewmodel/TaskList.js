    ...
    this.addItem = function() {
        if (this.itemToAddTitle() != "") {
			if(this.itemToAddDesc() != "")
				var newItem = {name: this.itemToAddTitle(), description: this.itemToAddDesc(), status: false};
			else
				var newItem = {name: this.itemToAddTitle(), description: this.itemToAddTitle(), status: false};
